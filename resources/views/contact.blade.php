...
@section('content')
<!-- Hero Section -->
<section class="relative h-[60vh] flex items-center justify-center bg-cover bg-center" style="background-image: url('{{ asset('storage/images/CONTACT US BG.png') }}');">
    <div class="absolute inset-0 bg-black/30"></div>
    <div class="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8">
        <h1 class="text-5xl md:text-7xl font-bold mb-4 uppercase tracking-wider">GET CLOSER</h1>
        <h2 class="text-4xl md:text-6xl font-normal uppercase tracking-wider">WITH US</h2>
    </div>
</section>
...
<section class="py-20 bg-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                <h2 class="text-3xl font-bold text-white mb-8 uppercase tracking-wider">CONTACT FORM</h2>
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                    @csrf
                    <div>
                        <label for="name" class="block text-sm font-medium text-white mb-2 uppercase tracking-wider">NAME</label>
                    ...
                    <div>
                        <label for="email" class="block text-sm font-medium text-white mb-2 uppercase tracking-wider">EMAIL</label>
                    ...
                    <div>
                        <label for="message" class="block text-sm font-medium text-white mb-2 uppercase tracking-wider">MESSAGE</label>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <div class="flex justify-center space-x-12">
                <!-- Instagram -->
                <a href="#" class="group">
                    <div class="w-20 h-20 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
                ...
                <!-- LinkedIn -->
                <a href="#" class="group">
                    <div class="w-20 h-20 bg-blue-600 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
                        <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
